package co.unicauca.digital.repository.back.domain.service.collection;
...
public interface ICollectionService {
     ...
     * @return Response object for the service, containing information about the
     *         transaction outcome.
     */
     ...
     * @return Response object for the service, indicating whether the deletion was
     *         successful.
     */
    ...
    Response<CollectionDtoResponse> getCollectionIdByContractualdocumentAndContract(Integer contractualDocumentId,
            Integer contractId);
