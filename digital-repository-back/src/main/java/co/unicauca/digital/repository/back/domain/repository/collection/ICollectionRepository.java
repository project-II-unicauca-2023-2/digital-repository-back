package co.unicauca.digital.repository.back.domain.repository.collection;
...
public interface ICollectionRepository extends JpaRepository<Collection, Integer> {
    ...
    Optional<Collection> findCollectionByContractIdAndContractualDocumentId(Integer contractId,
