package co.unicauca.digital.repository.back.domain.service.internalNormative.impl;

import co.unicauca.digital.repository.back.domain.dto.internalNormative.request.*;
import co.unicauca.digital.repository.back.domain.dto.internalNormative.response.*;
import co.unicauca.digital.repository.back.domain.mapper.internalNormative.IInternalNormativeMapper;
...
import co.unicauca.digital.repository.back.domain.service.internalNormative.IInternalNormativeService;
 ...
 * {@link IInternalNormativeService}
 */
@Service
@Primary
public class InternalNormativeServiceImpl implements IInternalNormativeService {
     ...
     * constructor method
     */
    public InternalNormativeServiceImpl(IInternalNormativeRepository internalNormativeRepository,
            IInternalNormativeMapper internalNormativeMapper) {
     ...
     */
    @Override
    public Response<InternalNormativeDtoCreateResponse> createInternalNormative(
            InternalNormativeDtoCreateRequest internalNormativeDtoCreateRequest) {

        InternalNormative internalNormativeModel = internalNormativeMapper
                .toEntityCreate(internalNormativeDtoCreateRequest);
        ...
        InternalNormativeDtoCreateResponse internalNormativeDtoCreateResponse = internalNormativeMapper
                .toDtoCreate(internalNormativeSaved);

        return new ResponseHandler<>(200, "Normativa interna creada exitosamente",
                "Normativa interna creada exitosamente", internalNormativeDtoCreateResponse).getResponse();
    }
    ...
    public Response<InternalNormativeDtoFindResponse> getById(Integer id) {
        ...
        if (internalNormative.isEmpty())
            throw new BusinessRuleException("internalNormative.request.not.found");

        InternalNormativeDtoFindResponse internalNormativeDtoFindResponse = internalNormativeMapper
                .toDtoFind(internalNormative.get());
        return new ResponseHandler<>(200, "Normativa interna encontrada", "Normativa interna encontrada",
                internalNormativeDtoFindResponse).getResponse();
    }
    ...
    public Response<PageableResponse<Object>> getAll(int pageNo, int pageSize) {
        ...
        List<Object> internalNormativeDtoFindResponses = responsePage.get().map(
                internalNormativeMapper::toDtoFind).collect(Collectors.toList());
        ...
        return new ResponseHandler<>(200, "Se obtuvieron todos los registros de normativa interna",
                "Se obtuvieron todos los registros de normativa interna", response).getResponse();
    }
     ...
     */
    @Override
    public Response<InternalNormativeDtoCreateResponse> updateInternalNormative(
            InternalNormativeDtoUpdateRequest internalNormativeDtoUpdateRequest) {

        Optional<InternalNormative> internalNormative = internalNormativeRepository
                .findById(internalNormativeDtoUpdateRequest.getId());
        if (internalNormative.isEmpty())
            throw new BusinessRuleException("internalNormative.request.not.found");
        ...
        return new ResponseHandler<>(200, "Normativa interna actualizada exitosamente",
                "Normativa interna actualizada exitosamente", internalNormativeDtoCreateResponse).getResponse();
    ...
    public Response<Boolean> deleteInternalNormative(Integer id) {
        ...
        return new ResponseHandler<>(200, "Normativa interna eliminada", "Normativa interna eliminada", true)
                .getResponse();
    }
}
