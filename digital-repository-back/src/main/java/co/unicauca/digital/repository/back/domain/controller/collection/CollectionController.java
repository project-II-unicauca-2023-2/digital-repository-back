package co.unicauca.digital.repository.back.domain.controller.collection;
...
public class CollectionController {
    ...
    @PostMapping
    public ResponseEntity<Response<CollectionDtoResponse>> createCollection(
            @Valid @RequestBody final CollectionDtoRequest collectionDtoRequest) {
        return new ResponseEntity<>(this.collectionService.createCollection(collectionDtoRequest), HttpStatus.OK);
    }

    @PostMapping("/all")
    public ResponseEntity<Response<List<CollectionDtoResponse>>> saveDocuments(
            @RequestBody final List<CollectionDtoRequest> collectionDtoRequests) {
    ...
    @PutMapping
    public ResponseEntity<Response<CollectionDtoResponse>> update(
            @Valid @RequestBody CollectionDtoRequest collectionDtoRequest) {
    ...
    public ResponseEntity<Response<CollectionDtoResponse>> getCollectionIdByContractualdocumentAndContract(
            @PathVariable("contractualDocumentId") int contractualDocumentId,
            @PathVariable("contractId") int contractId) {
        return new ResponseEntity<>(this.collectionService
                .getCollectionIdByContractualdocumentAndContract(contractualDocumentId, contractId), HttpStatus.OK);
    }
