...
public class ContractTypeController {
     ...
     *
     * @param contractTypeDtoCreateRequest {@link ContractTypeDtoCreateRequest}
     *                                     Object with the information to be
     *                                     inserted, received in the body of the
     *                                     request to the service
     * @return {@link Response} Response object for the service, which contains
     *         information about the outcome of the transaction.
     */
    @PostMapping("")
    public ResponseEntity<Response<ContractTypeDtoCreateResponse>> createModality(
            @Valid @RequestBody final ContractTypeDtoCreateRequest contractTypeDtoCreateRequest) {
        return new ResponseEntity<>(this.contractTypeService.createContractType(contractTypeDtoCreateRequest),
                HttpStatus.OK);
    }
     ...
     *
     * @param contractTypeDtoUpdateRequest {@link ContractTypeDtoUpdateRequest}
     *                                     Object with the information to be
     ...
     */
    @PatchMapping("")
    public ResponseEntity<Response<ContractTypeDtoCreateResponse>> updateModality(
            @Valid @RequestBody final ContractTypeDtoUpdateRequest contractTypeDtoUpdateRequest) {
        return new ResponseEntity<>(this.contractTypeService.updateContractType(contractTypeDtoUpdateRequest),
                HttpStatus.OK);
    }
