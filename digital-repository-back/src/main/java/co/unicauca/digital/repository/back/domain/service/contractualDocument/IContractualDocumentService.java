package co.unicauca.digital.repository.back.domain.service.contractualDocument;
 ...
 * the ContractualDocument entity.
 */
public interface IContractualDocumentService {
     ...
     */
    Response<ContractualDocumentDtoCreateResponse> createContractualDocumentType(
            final ContractualDocumentDtoCreateRequest contractualDocumentDtoCreateRequest);
