package co.unicauca.digital.repository.back.domain.service.internalNormative;

import co.unicauca.digital.repository.back.domain.dto.internalNormative.request.InternalNormativeDtoCreateRequest;
import co.unicauca.digital.repository.back.domain.dto.internalNormative.request.InternalNormativeDtoUpdateRequest;
...
public interface IInternalNormativeService {
     ...
     */
    Response<InternalNormativeDtoCreateResponse> createInternalNormative(
            final InternalNormativeDtoCreateRequest internalNormativeDtoCreateRequest);
     ...
     *                                          Object with the information to be
     *                                          updated, received in the body
     * @return {@link Response} Response object for the service, which contains
     *         information about the outcome of the transaction.
     */
    Response<InternalNormativeDtoCreateResponse> updateInternalNormative(
            final InternalNormativeDtoUpdateRequest internalNormativeDtoUpdateRequest);
