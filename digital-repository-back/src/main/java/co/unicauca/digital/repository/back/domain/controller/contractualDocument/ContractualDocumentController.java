package co.unicauca.digital.repository.back.domain.controller.contractualDocument;
...
public class ContractualDocumentController {
    ...
    /**
     * Object used to invoke the operations of the IContractualDocumentService
     * interface
     */
     ...
     *
     * @param contractualDocumentDtoCreateRequest {@link ContractualDocumentDtoCreateRequest}
     ...
     */
    @PostMapping("")
    public ResponseEntity<Response<ContractualDocumentDtoCreateResponse>> createContractualDocument(
            @Valid @RequestBody final ContractualDocumentDtoCreateRequest contractualDocumentDtoCreateRequest) {
        return new ResponseEntity<>(
                this.contractualDocumentService.createContractualDocumentType(contractualDocumentDtoCreateRequest),
                HttpStatus.OK);
    }
