...
public interface ICriteriaRepository extends JpaRepository<Criteria, Integer> {
     ...
     */
    // @Query("SELECT c.id, c.name, c.description FROM Criteria c where
    // c.criteriaType=:paramType")
    // List<CriteriaDtoConsultResponse> getCriteriaByType(@Param("paramType") String
    // criteriaType);
    ...
    Optional<Criteria> findByNameAndCriteriaType(String name, String criteriaType);
