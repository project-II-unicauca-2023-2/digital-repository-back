package co.unicauca.digital.repository.back.domain.service.modality.impl;
...
import co.unicauca.digital.repository.back.domain.dto.modality.request.ModalityDtoUpdateRequest;
...
import co.unicauca.digital.repository.back.domain.mapper.modality.IModalityMapper;
...
/**
 * Class in charge of implementing the IModalityService interface
 * {@link IModalityService}
 */
@Service
@Primary
public class ModalityServiceImpl implements IModalityService {
    ...
    public Response<ModalityDtoFindResponse> getById(int id) {
        ...
        if (modalityFound.isEmpty())
            throw new BusinessRuleException("modality.request.not.found");
    ...
    public Response<PageableResponse<Object>> getAll(int pageNo, int pageSize) {
        ...
        List<Object> modalityDtoFindResponses = responsePage.get().map(
                modalityMapper::toDtoFind).collect(Collectors.toList());
    ...
    public Response<ModalityDtoCreateResponse> createModality(ModalityDtoCreateRequest modalityDtoCreateRequest) {
        if (entityExistsByExternalCode(modalityDtoCreateRequest.getExternalCode()))
        ...
        return new ResponseHandler<>(200, "Modalidad creada exitosamente", "Modalidad creada exitosamente",
                modalityDtoCreateResponse).getResponse();
    }
    ...
    public Response<ModalityDtoCreateResponse> updateModality(ModalityDtoUpdateRequest modalityDtoUpdateRequest) {
        ...
        return new ResponseHandler<>(200, "Modalidad actualizada exitosamente", "Modalidad actualizada exitosamente",
                modalityDtoCreateResponse).getResponse();
    }
    ...
    public Response<Boolean> deleteModality(int id) {
        ...
        return new ResponseHandler<>(200, "Modalidad eliminada exitosamente", "Modalidad eliminada exitosamente",
                !modalityRepository.existsById(id)).getResponse();
    }
