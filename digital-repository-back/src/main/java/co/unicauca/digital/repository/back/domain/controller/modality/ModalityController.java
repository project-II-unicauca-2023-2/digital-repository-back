package co.unicauca.digital.repository.back.domain.controller.modality;
...
public class ModalityController {
     ...
     *
     * @param modalityDtoCreateRequest {@link ModalityDtoCreateRequest} Object with
     ...
     */
    @PostMapping("")
    public ResponseEntity<Response<ModalityDtoCreateResponse>> createModality(
            @Valid @RequestBody final ModalityDtoCreateRequest modalityDtoCreateRequest) {
     ...
     *
     * @param modalityDtoUpdateRequest {@link ModalityDtoUpdateRequest} Object with
     ...
     */
    @PatchMapping("")
    public ResponseEntity<Response<ModalityDtoCreateResponse>> updateModality(
            @Valid @RequestBody final ModalityDtoUpdateRequest modalityDtoUpdateRequest) {
