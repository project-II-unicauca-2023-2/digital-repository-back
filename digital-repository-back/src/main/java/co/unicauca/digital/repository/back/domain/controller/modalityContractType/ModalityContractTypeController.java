package co.unicauca.digital.repository.back.domain.controller.modalityContractType;
...
public class ModalityContractTypeController {
     ...
     *
     * @param modalityContractTypeDtoCreateRequest {@link ModalityContractTypeDtoCreateRequest}
     *                                             Object with the information to be
     *                                             inserted, received in the body of
     *                                             the request to the service
     * @return {@link Response} Response object for the service, which contains
     *         information about the outcome of the transaction.
     */
    @PostMapping("")
    public ResponseEntity<Response<ModalityContractTypeDtoCreateResponse>> createModalityContractType(
            @Valid @RequestBody final ModalityContractTypeDtoCreateRequest modalityContractTypeDtoCreateRequest) {
        return new ResponseEntity<>(
                this.modalityContractTypeService.createModalityContractType(modalityContractTypeDtoCreateRequest),
                HttpStatus.OK);
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Response<ModalityContractTypeDtoFindResponse>> getById(
    ...
    // */
    // @GetMapping("")
    // public ResponseEntity<Response<ModalityContractTypeDtoFindResponse>>
    // getByContractModality(
    // @RequestParam(value = "contractTypeId", required = true) Integer
    // contractTypeId,
    // @RequestParam(value = "modalityId", required = true) Integer modalityId) {
    // return new
    // ResponseEntity<>(this.modalityContractTypeService.getByContractModality(contractTypeId,
    // modalityId), HttpStatus.OK);
    // }

    /**
     * API to update a modality contract type
     *
     * @param modalityContractTypeDtoUpdateRequest {@link ModalityContractTypeDtoUpdateRequest}
     *                                             Object with the information to be
     *                                             updated, received in the body of
     *                                             the request to the service
     * @return {@link Response} Response object for the service, which contains
     *         information about the outcome of the transaction.
     */
    @PatchMapping("")
    public ResponseEntity<Response<ModalityContractTypeDtoCreateResponse>> updateModalityContractType(
            @Valid @RequestBody final ModalityContractTypeDtoUpdateRequest modalityContractTypeDtoUpdateRequest) {
        return new ResponseEntity<>(
                this.modalityContractTypeService.updateModalityContractType(modalityContractTypeDtoUpdateRequest),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<Response<List<ContractualDocumentDtoFindResponse>>> getCheckList(
            @Valid @PathVariable final Integer id) {
