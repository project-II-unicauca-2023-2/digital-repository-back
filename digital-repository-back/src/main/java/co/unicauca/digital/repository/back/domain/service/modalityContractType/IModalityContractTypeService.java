package co.unicauca.digital.repository.back.domain.service.modalityContractType;
 ...
 * the ModalityContractType entity.
 */
public interface IModalityContractTypeService {
     ...
     */
    Response<ModalityContractTypeDtoCreateResponse> createModalityContractType(
     ...
     *         information about the outcome of the transaction.
     */
    Response<ModalityContractTypeDtoFindResponse> getByContractModality(final Integer contractTypeId,
            final Integer modalityId);
     ...
     *         information about the outcome of the transaction.
     */
    Response<ModalityContractTypeDtoCreateResponse> updateModalityContractType(
            final ModalityContractTypeDtoUpdateRequest modalityContractTypeDtoUpdateRequest);
